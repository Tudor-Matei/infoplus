...
function checkFieldsValidity(_ref) {
  ...
  if (thereAreEmptyFields(Object.value(fields))) return "Nu ai completat unul sau mai multe câmpuri.";else if (fieldValuesAreNotLongEnough(fields, minimumLengthForEachField)) return "Unul sau mai multe câmpuri nu indeplinesc numarul de caractere minim.";else if (hasEmail && !validator_lib_isEmail__WEBPACK_IMPORTED_MODULE_1___default()(fields.email)) return "E-mail-ul pe care l-ai introdus nu este valid.";
  return false;
}
...
//# sourceMappingURL=index.js.3d728f66e735c168388e.hot-update.js.map