...
function InputAreas(_ref) {
  ...
  return inputAreaRegisterData.length % 2 !== 0 ? InputAreasOddArrayLength({
...
function InputAreasOddArrayLength(_ref2) {
  ...
  return inputAreaRegisterData.map(function (props, i) {
    return i % 2 === 0 && __jsx("div", {
      ...
      className: "modal__input-panel ".concat(i + 1 === inputAreaRegisterData.length && "modal__input-panel--last"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 14,
    ...
    }))), i + 1 !== inputAreaRegisterData.length && __jsx("div", {
    ...
    }, __jsx(_utils_InputArea__WEBPACK_IMPORTED_MODULE_2__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, inputAreaRegisterData[i + 1], {
      key: "input__".concat(i + 1, "-fields"),
      eventHandler: function eventHandler(e) {
        return updateDetails(e, inputAreaRegisterData[i + 1].fieldName);
      },
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.fd2969a29a9364294dc5.hot-update.js.map