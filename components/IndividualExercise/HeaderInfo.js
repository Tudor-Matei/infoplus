  ...
  return (
    <div className="header-info-exercise">
      ...
      <div className="header-info-exercise__secondary-details">
        ...
        <div className="header-info-exercise__secondary-detail">
          <FontAwesomeIcon icon="memory" className="header-info-exercise__icon--needs-media-query" />
        ...
        <div className="header-info-exercise__secondary-detail">
          ...
          <p>Soluții trimise: {sentSolutions}</p>
        </div>

        <div className="header-info-exercise__secondary-detail">
          <p className="header-info-exercise__secondary-details--no-border">
            Clasa {exerciseLocation.grade.toUpperCase()}
            <span>{" > "}</span>
            {exerciseLocation.category}
            <span>{" > "}</span>
            {exerciseLocation.subcategory}
          </p>
        </div>
      </div>
      <style jsx>{`
