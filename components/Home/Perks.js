  ...
  return (
    <section className="perks">
      ...
      <PerkPanel title="Viteză" icon="bolt">
        infoplus a fost conceput cu eficiență, accesibilitate și viteză de încărcare în considerare, pentru a conferi
        calculatoarelor școlare deficitare o experiență plăcută.
      </PerkPanel>
      <PerkPanel title="Conveniență" icon="coffee">
        Cu trăsături făcute pentru a ușura viața atât celui care predă, cât și a elevului, toate necesitățile cheie sunt
      ...
      <PerkPanel title="Stabilitate" icon="mountain">
        ...
        le rezolvi, este inutilă, deoarece acest site este online 24/7.
      </PerkPanel>
      <style jsx>
        {`
          .perks {
